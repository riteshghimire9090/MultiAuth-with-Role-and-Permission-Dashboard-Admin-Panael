...
//        return "hello";
    ...
    {
        \request()->validate(
         ["email"=>"required|email|max:255|email","name"=>"required",            'role_id'  => 'required',
         ]
        );
//        return $request;
        $admin             = $this->adminModel::findOrFail($adminId);
    ...
    public function updateProfile(){
        ...
        if ($files = request()->file('avatar')){
            ...
            $admin->avatar =  "images/".$profileImage;
        ...
        return redirect()->back()->with("message","You have update successfully");
